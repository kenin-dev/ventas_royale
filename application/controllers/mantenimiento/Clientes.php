...
class Clientes extends CI_Controller {
	...
	public function store(){
		...
		$this->form_validation->set_rules("paterno","Apellido Paterno del Cliente","required");
		$this->form_validation->set_rules("materno","Apellido Materno del Cliente","required");
