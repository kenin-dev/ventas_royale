$(document).ready(function () {
    ...
    $(".btn-view-producto").on("click", function(){
        ...
        html = "<p><strong>Abrev:</strong>"+infoproducto[1]+"</p>"
...
//    });
    $("#btn-agregar").on("click",function(){
        ...
        if (data !='') {
            ...
            html += "<td><input class='form-control' type='hidden' name='precios[]' value='"+infoproducto[3]+"'>"+infoproducto[3]+"</td>";
            // html += "<td>"+infoproducto[4]+"</td>";
            html += "<td><input type='text' name='cantidades[]' value='1' class='cantidades form-control' onkeypress='return soloNumeros(event)'></td>";
            html += "<td><input type='hidden' name='importes[]' value='"+infoproducto[3]+"'><p>"+infoproducto[3]+"</p></td>";
            html += "<td><input type='text' name='detalles[]' class='detalles form-control'></td>";
...
// document.querySelector('.soloNum').addEventListener('keypress', soloNumeros(event),false);
